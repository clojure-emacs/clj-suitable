...
```clojure
:aliases {:suitable {:extra-deps {org.rksm/suitable {:mvn/version "0.2.13"}}
...
Add `[org.rksm/suitable "0.2.13"]` to your dependencies vector.
...
<!-- ```lisp -->
<!-- (cider-add-to-alist 'cider-jack-in-cljs-dependencies "org.rksm/suitable" "0.2.13") -->
